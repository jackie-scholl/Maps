 ...
 */
/*
 * /** Constructs an empty {@code HashtableB} with the default {@code maximum}, {@code minimum}, and {@code set}
 * fullness ratios.
 */
/*
 ...
 * @param minimum the minimum fullness
 * 
 * @throws IllegalArgumentException if {@code minimum} is less than or equal to zero or {@code minimum} is greater than
 * the default {@code set} or {@code maximum} is less than or equal to the default {@code set} or {@code maximum} is
 * greater than one.
 */
/*
 * /** Associates the specified value with the specified key in this hash table. If the hash table previously contained
 ...
 * 
 * @return {@code true} if this hash table contains a mapping for the specified key
 * 
 * @throws NullPointerException if the specified key is null
 */
/*
